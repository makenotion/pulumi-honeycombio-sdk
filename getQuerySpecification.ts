...
export function getQuerySpecificationOutput(args?: GetQuerySpecificationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetQuerySpecificationResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
