...
export class MsteamsRecipient extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MsteamsRecipientState, opts?: pulumi.CustomResourceOptions): MsteamsRecipient {
        return new MsteamsRecipient(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'honeycombio:index/msteamsRecipient:MsteamsRecipient';

    /**
     * Returns true if the given object is an instance of MsteamsRecipient.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MsteamsRecipient {
    ...
    constructor(name: string, argsOrState?: MsteamsRecipientArgs | MsteamsRecipientState, opts?: pulumi.CustomResourceOptions) {
